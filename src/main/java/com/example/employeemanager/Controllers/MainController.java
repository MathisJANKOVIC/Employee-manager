...
public class MainController {
  ...
  public @ResponseBody String addNewUser(@RequestParam String fisrtName, @RequestParam String lastName,
      @RequestParam String password, @RequestParam Date hireDate, @RequestParam String mail,
